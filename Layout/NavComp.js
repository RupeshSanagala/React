...
const NavComp = () => {
  return (
    <div>
        ...
        <Link to="FormValidationTask" className='btn btn-primary btn-sm'>FormValidationTask</Link>{" "}
        <Link to="ProductDashComp" className='btn btn-info btn-sm'>ProductDashComp</Link>{" "}
